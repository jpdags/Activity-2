...
const sphere = new THREE.Mesh(
    new THREE.TorusGeometry(6, 2, 40, 100),
    material
)
sphere.rotation.x = Math.PI * 0.5
sphere.scale.set(0.1, 0.1, 0.1)
sphere.castShadow = true//<<<<<ADDED
...
directionalLight.castShadow = true//<<<<<ADDED
/**
 * Sizes
 */
const sizes = {
...
//ADDED==================================
directionalLight.shadow.mapSize.width = 1524
directionalLight.shadow.mapSize.height = 1524
